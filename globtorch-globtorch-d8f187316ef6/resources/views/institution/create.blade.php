            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h2>Create a school/institution</h2>
                    </div>
                    <div class="card-body">
                        <br />
                        {!! Form::open(['action' => 'InstitutionController@store', 'method'=>'POST', 'files' => 'true']) !!}
                            <div class="form-group row">
                                {{Form::label('name', 'Name', ['class'=>'col-lg-4 col-form-label'])}}
                                {{Form::text('name', null, ['class'=>'form-control col-lg-5','required'])}}
                            </div>
                            <div class="form-group row">
                                {{Form::label('address', 'Address', ['class'=>'col-lg-4 col-form-label'])}}
                                {{Form::textarea('address', null, ['class'=>'form-control col-lg-5', 'style'=>'height:100%'])}}
                            </div>
                            <div class="form-group row">
                                {{Form::label('phone', 'Phone', ['class'=>'col-lg-4 col-form-label'])}}
                                {{Form::text('phone', null, ['class'=>'form-control col-lg-5'])}}
                            </div>
                            <div class="form-group row">
                                {{Form::label('email', 'Email', ['class'=>'col-lg-4 col-form-label'])}}
                                {{Form::email('email', null, ['class'=>'form-control col-lg-5'])}}
                            </div>
                            <div class="form-group row">
