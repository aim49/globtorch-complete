    ...
    <div class="page-wrapper">
        <div class="row page-titles">
            <div class="col-md-3 align-self-center">
                <h3 class="text-primary"><a href="{{route('course.index', $course->id)}}">{{$course->name}}</a></h3>
            </div>
            <div class="col-md-3 align-self-center">
                                ...
                                @if (count($course->subjects) > 0)
                                    @foreach ($course->subjects as $subject )
                                        ...
                                        <div class="welcome-box">
                                            ...
                                            <br/>  <br/>
                                                    <a href="{{route('course.subject.chapter.index', [$course->id, $subject->id])}}" title="View Subject">View</a>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
