                    ...
                    <div class="card">
                        <div class="card-title">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    {!! Form::open(['action' => ['CourseSubjectController@destroy', $course->id, $subject->id], 'method'=>'DELETE']) !!}
                                        {{Form::submit('Remove From Course', ['class' => 'btn btn-danger'])}}
                                    {!! Form::close() !!}
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-validation">
                            {!! Form::open(['action' => ['CourseSubjectController@store', $course->id], 'method'=>'POST']) !!}
                    ...
                    <div class="card-footer">
                        <a class="btn btn-primary" href="{{route('course.subject.add', $course->id)}}">Add From Existing Subjects</a>
                    </div>
                </div>
            </div>
        </div>
