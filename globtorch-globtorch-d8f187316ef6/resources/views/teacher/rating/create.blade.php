                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-validation">
                            ...
                            {!! Form::open(['action' => 'TeacherRatingsController@store', 'method'=>'POST']) !!}
                                <div class="form-group row">
                                    {{Form::label('score', 'Score', ['class'=>'col-lg-4 col-form-label'])}}
                                    <div style="display:none">
                                        {{Form::number('score', '', ['class' => 'form-control col-lg-6', 'required', 'min'=>'1', 'max'=>'5', 'id' => 'score'])}}
                                    </div>
                                    @for ($i = 0; $i < 5; $i++)
                                ...
                                <div class="form-group row">
                                    ...
                                    {{Form::textarea('comment', '', ['class' => 'form-control col-lg-6', 'placeholder' => 'Enter comment..', 'required', 'style'=>'height:100%', 'maxlength' => '255'])}}
                                </div>
